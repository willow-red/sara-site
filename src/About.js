...
export default function About() {
    return (
        <div id="about" className="mt-5 mb-5">
            ...
            In addition to being a self-proclaimed software developer, I am a <a className="link" href="https://willowred.art/" target="_blank" rel="noreferrer">multimedia artist</a>! My
            two passions seem distinct in concept, but I strive to combine them in my projects to create something unique.<br></br><br></br>
            With my knowledge of art, design, and code, I create software that is beautiful, inside and out.
            My main focuses are websites and games. I also design ui and illustrate for projects.</p>
            <h4>what I do</h4>
            <ul>
                <li>Work as a TA for USC <a className="link" href="https://itp.usc.edu/" target="_blank" rel="noreferrer">
                    Information Technology Program</a> courses, including ITP104 (Web Publishing)
                    and ITP301 (Front-End Web Development)
                </li>
                <li>Graphic design for <a className="link" href="https://studentaffairs.usc.edu/" target="_blank" rel="noreferrer">USC Student Affairs</a></li>
                <li>Am the webmaster for <a className="link" href="https://kxsc.org/" target="_blank" rel="noreferrer">KXSC</a>,
                 USC's student-run radio (I also DJ a weekly radio show!)</li>
                <li>Design websites for clients with <a className="link" href="https://www.innodatusc.com/" target="_blank" rel="noreferrer">
                    InnoD @ USC</a></li>
            </ul>
            <h4>skills</h4>
            <ul>
